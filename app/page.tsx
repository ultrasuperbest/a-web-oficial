...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white selection:bg-indigo-500 selection:text-white font-sans">
      ...
      <main>
        ...
        <section className="relative pt-40 pb-24 px-6 text-center overflow-hidden">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto text-lg mb-12">
            Entretenimiento digital de alto rendimiento. Videos, juegos y contenido exclusivo.
          </p>
        ...
        <section id="juegos" className="bg-indigo-600 py-24">
          ...
          <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center gap-16">
            ...
            <div className="md:w-1/2">
              ...
              <h2 className="text-5xl font-black mb-6 tracking-tight leading-none text-white">
                GAMING ZONE
              </h2>

              <p className="text-indigo-100 text-xl mb-8 leading-relaxed italic">
                Prueba nuestro nuevo motor de juegos en el navegador.
              </p>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <button
                  ...
                  className="bg-white text-black px-10 py-5 rounded-full font-bold uppercase tracking-tighter hover:scale-105 transition-transform flex items-center gap-3"
                >
                  Arcanoid Pro <Play size={20} />
                </button>

                <button
                  onClick={() => setIsRPGOpen(true)}
                  className="bg-black text-white px-10 py-5 rounded-full font-bold uppercase tracking-tighter hover:scale-105 transition-transform flex items-center gap-3"
                >
                  RPG Manager <Play size={20} />
                </button>
      ...
      {/* --- JUEGOS (Se cargan solo cuando se abren) --- */}

      {isGameOpen && (
        <QuantumClicker onClose={() => setIsGameOpen(false)} />
      )}

      {isArcanoidOpen && (
        <Arcanoid onClose={() => setIsArcanoidOpen(false)} />
      )}

      {isRPGOpen && (
        <RPGManager onClose={() => setIsRPGOpen(false)} />
      )}
